...
# ---------------------------------------------------------------------------
# Helpers — minimal stubs so the modules can be imported without the full
# project environment (BioPython, RDKit, …) being present in CI.
# ---------------------------------------------------------------------------
...
# ---------------------------------------------------------------------------
# We import the functions directly so we don't need the full config machinery.

# p2rank_stage lives at pocket_logic/p2rank_stage.py.  Add pocket_logic/ to
# sys.path so the relative imports inside it resolve.
_HERE = os.path.dirname(__file__)
_POCKET_LOGIC = os.path.join(_HERE, "..", "pocket_logic")
if _POCKET_LOGIC not in sys.path:
    sys.path.insert(0, _POCKET_LOGIC)

# Stub geometry_utils and merge_utils so p2rank_stage can be imported in
# isolation.
...
# ---------------------------------------------------------------------------
# 3 — Pipeline behaviour with P2Rank results present
# ---------------------------------------------------------------------------
...
# ---------------------------------------------------------------------------
# 5 — Regression: GeneoNet is no longer imported or executed
# ---------------------------------------------------------------------------
