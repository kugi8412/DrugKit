# -*- coding: utf-8 -*-
"""Integration tests for the end-to-end DrugKit pipeline.

These tests verify that the major pipeline stages work together:
1. SMILES -> PyG featurization
2. Model training (Siamese RankNet)
3. Active learning loop
4. Docking adapter (mocked)
5. Selectivity scoring
"""
...
# --- Phase 2 Tests: Deep Docking Pipeline ---
