...
pip install -i https://test.pypi.org/simple/ drugkit==0.1.3
...
drugkit-dock --grids data/docking_grids.json --ligands data/pool.csv --smina-exe YOUR/PATH/smina
...
# New data
wget https://deepchemdata.s3-us-west-1.amazonaws.com/datasets/delaney-processed.csv -O data/new_data.csv
drugkit-expand --seeds data/seed_ligands.csv --output output/expanded.csv --max-analogs 50 --similarity-cutoff 0.1 --database data/new_data.csv
```
